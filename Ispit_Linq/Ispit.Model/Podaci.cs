...
namespace Ispit.Model
{
    public class Podaci
    {
        ...
        public static List<Klijent> ListaKlijenata = new()
        {
            ...
            new Klijent {ImePrezime = "Luka Modrić", Banka = "MODRI", Stanje = 3000000},
            new Klijent {ImePrezime = "Zlatko Dalić", Banka = "DALI", Stanje = 10000000},
            new Klijent {ImePrezime = "Zlatan Ibrahimović", Banka = "MAMINJO", Stanje = 2000000},
            new Klijent {ImePrezime = "Mario Mandžukić", Banka = "MAMINJO", Stanje = 15000000},
